...
// State-appropriate body copy for the RCV/ACV sidebar card. Keep this in sync with the
// duplicated copy of the same three strings in src/browser/smart-lookup-controller.js
// (that file is a classic, non-module script — see the RCV_ACV_ITEM_IDS comment above for
// why matching logic is duplicated there instead of imported).
export function getRcvAcvSidebarCopy(basis) {
