...
export function createNativeResearchRefinementResult({
  ...
  if (decision.status === 'resolved') {
    return createRefinementResponse({
      ...
      confidence: research.refinementConfidence || 'low',
  ...
  // Ambiguous: only publish when the research actually eliminated something.
  // Otherwise the existing research path still deserves its turn.
