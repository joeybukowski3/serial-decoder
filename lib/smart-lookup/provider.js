import { ESTIMATE_FIRST_RESEARCH_OBJECTIVE } from './research-policy.js';
...
export function buildAgeProviderPrompt(queryInfo) {
  const userNotes = queryInfo.userNotes
    ...
    : 'None';
  return `${ESTIMATE_FIRST_RESEARCH_OBJECTIVE}

Identify model-level timing information for this physical property item.
...
Return JSON only:
{
  ...
  "bestEstimateYear": 2021,
  "estimatedRange": {"start": 2021, "end": null},
  "rangeLabel": "2021 or later",
  "estimateBasis": "model-introduction | production-range | model-line-generation | product-family-introduction | category-era | heuristic",
  "confidence": "high | medium | low",
  "summary": "Short estimate that distinguishes product timing from the individual unit date.",
...
Research model-level timing information for this physical property item using Google Search.
...
Research the physical product this query refers to, using web search, and report model-level timing information.
