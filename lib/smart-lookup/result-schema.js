...
export function normalizeSmartAgeResult(raw, options = {}) {
  ...
  if (introductionYear != null && productionRange && (introductionYear < productionRange.start || introductionYear > productionRange.end)) {
    throw new SmartLookupValidationError('INTRODUCTION_OUTSIDE_RANGE');
  }
