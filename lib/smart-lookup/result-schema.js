...
// 'openai-web' is a real web-search-cited OpenAI result; 'openai-ungrounded'
// is an OpenAI answer where the web_search tool produced no citations. They
// are kept distinct so an ungrounded estimate can never be presented to the
// user as web-researched.
const EVIDENCE_SOURCES = new Set(['local-db', 'user-verified', 'gemini-grounded', 'gemini-ungrounded', 'openai-web', 'openai-ungrounded', 'groq-ungrounded', 'heuristic', 'none']);
...
const CITED_EVIDENCE_SOURCES = new Set(['gemini-grounded', 'openai-web']);
