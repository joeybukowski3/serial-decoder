...
const SOURCES = new Set(['local-db', 'decoder-verified', 'cache', 'static', 'gemini', 'groq', 'xai', 'fallback', 'none']);
...
const EVIDENCE_SOURCES = new Set(['local-db', 'user-verified', 'gemini-grounded', 'gemini-ungrounded', 'openai-web', 'openai-ungrounded', 'xai-web', 'xai-ungrounded', 'groq-ungrounded', 'heuristic', 'none']);
...
const CITED_EVIDENCE_SOURCES = new Set(['gemini-grounded', 'openai-web', 'xai-web']);
