  ...
  try {
    ...
    try {
      ...
      return attachProviderMetadata(value, {
        ...
        model: options.groqModel || (options.env || process.env).GROQ_MODEL || 'openai/gpt-oss-20b',
      ...
      throw new SmartLookupProviderError(
        ...
        'OpenAI and Groq providers were unavailable',
        {
          ...
          fallbackModel: fallbackError?.model || ((options.env || process.env).GROQ_MODEL || null),
