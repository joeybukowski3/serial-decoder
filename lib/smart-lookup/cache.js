...
// Bumped again for usefulness-first routing plus the OpenAI-primary provider
// sequence. This is the mechanism that stops previously-cached "brand needed"
// and broad-guidance clarification cards -- written while research was gated
// off -- from being served back and masking the new routing and provider.
export const SMART_AGE_POLICY_VERSION = 'progressive-context-xai-2';
...
export function chooseSmartAgeTtl(result) {
  ...
  if (result.evidenceSource === 'openai-web' || result.evidenceSource === 'xai-web') return 7 * 24 * 60 * 60;
