...
function acceptedMatchTypes(querySpecificity) {
  if (querySpecificity === 'exact-model') return new Set(['exact']);
  if (querySpecificity === 'model-line') return new Set(['exact', 'variant', 'family']);
  if (querySpecificity === 'product-family') return new Set(['exact', 'variant', 'family']);
  return new Set(['exact', 'variant', 'family']);
}
